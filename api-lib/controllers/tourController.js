...
import factory from 'api-lib/controllers/handlerFactory'
...
export const getAllTours = factory.getAll(Tour, 'tours');
export const getTour = factory.getOne(Tour, 'tour', { path: 'reviews' });
export const createTour = factory.createOne(Tour, 'tour');
...
export const getMonthlyPlan = async (req, res, next) => {
  const year = req?.query?.year || req?.params?.year * 1; // 2021
